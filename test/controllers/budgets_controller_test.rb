...
class BudgetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create budget" do
    assert_difference('Budget.count') do
      post budgets_url, params: { budget: { category: @budget.category, value: @budget.value } }
    end
  ...
  test "should update budget" do
    patch budget_url(@budget), params: { budget: { category: @budget.category, value: @budget.value } }
